...
func TestCsvCreateUsers(t *testing.T) {
	...
	testCases := []CmdTestCase{
		...
		},
		{
			...
			errorMessage:   "",
			successMessage: `{"gid":1,"name":"test","description":"test","members":[{"uid":3,"username":"saul","name":"","firstname":"","lastname":"","email":"","ssh_public_key":"","jpeg_photo":"","manager":false,"readonly":false,"locked":false},{"uid":4,"username":"kim","name":"","firstname":"","lastname":"","email":"","ssh_public_key":"","jpeg_photo":"","manager":false,"readonly":false,"locked":false},{"uid":6,"username":"gumball","name":"Gumball Watterson","firstname":"Gumball","lastname":"Watterson","email":"gumbal@example.org","ssh_public_key":"","jpeg_photo":"","manager":true,"readonly":false,"locked":false},{"uid":7,"username":"anais","name":"Anais Watterson","firstname":"Anais","lastname":"Watterson","email":"anais@example.org","ssh_public_key":"","jpeg_photo":"","manager":false,"readonly":false,"locked":true}]}` + "\n",
		},
		{
